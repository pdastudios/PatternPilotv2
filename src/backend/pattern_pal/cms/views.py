...
class ShapeViewSet(viewsets.ModelViewSet):
    queryset = Shape.objects.all()  # Queryset for fetching all shapes
    serializer_class = ShapeSerializer  # Serializer class for serializing shapes

    def get_serializer_context(self):
        """
        Extra context provided to the serializer class.
        This is useful for passing additional context information
        to the serializer.
        """
